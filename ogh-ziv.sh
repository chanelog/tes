...
# ════════════════════════════════════════════════════════════
#  MENU UTAMA  — 2-Column Box Style
# ════════════════════════════════════════════════════════════
main_menu() {
    # Kolom kiri=28, kanan=29 → total 2+1+28+1+29+1=62 = lebar header
    # Format isi: ' [N]  EMJ  TXT<pad> '  = 1+3+2+2+2+len+pad+1 = 11+len+pad
    # Kiri : 11+len+pad=28 → pad=17-len
    # Kanan: 11+len+pad=29 → pad=18-len
    # helper 2-col row functions (unused)
    # Border: kiri 28, kanan 29 → sejajar dengan header 58
    # helper 2-col (unused)
    ...
    while true; do
        ...
        # ── Menu Items ────────────────────────────────────────
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[1]${NC}  👤  Kelola Akun"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[2]${NC}  ⚙   Service"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[3]${NC}  🤖  Telegram Bot"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[4]${NC}  🛒  Menu Jualan"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[5]${NC}  📊  Bandwidth"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[6]${NC}  🔄  Restart Service"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[7]${NC}  🚀  Install"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[8]${NC}  🌐  Domain"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A2}[9]${NC}  🎨  Tema [${THEME_NAME}]"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${LR}[E]${NC}  🗑   Uninstall"
        echo -e "  ${A1}${_DASH}${NC}"
        echo -e "  ${A4}[0]${NC}  ✗   Keluar"
        echo -e "  ${A1}${_DASH}${NC}"
